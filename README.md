# SaperOnline (Qt 6, Widgets, Client/Server)

Модульный учебный проект “Сапёр” на Qt 6.
...
## Примечание
Игровая логика работает **локально на клиенте**, а сервер отвечает только за аккаунты, роли и статистику.
